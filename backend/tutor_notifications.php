<?php
// tutor_notifications.php - Gestion des notifications du tuteur
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    try {
        $stmt = $pdo->prepare("
            ...
            LIMIT :limit
        ");
        $stmt->bindValue(':tutor_id', $tutorId, PDO::PARAM_STR);
...
elseif ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
    ...
    try {
        $stmt = $pdo->prepare("
            ...
            WHERE id = :notification_id AND recipient_type = 'tutor'
        ");
